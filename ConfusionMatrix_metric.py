...
path = 'TrainedModels/Pytorch_lightning_consensus_oversample5_rotate_norm_resnet18_metric_new/epoch=394-step=42659.ckpt'
...
torch.save(state_dict, path[:-5] + 'update.ckpt')
# state_dict = {}
model = TrachomaClassifier.load_from_checkpoint(path[:-5] + 'update.ckpt', model=model, strict=True)
