        ...
        if size > 1000:
            ...
            if len(keypoints) > 0:
                ...
                for coord in annot_foll:
                    ...
                    crop_img.save(
                        '/media/dsocia22/T7/Trachoma/annotated_data/FollicleDetection/singleFollicleImages/Images/{}_{}_{}.jpg'.format(
                            mask_ind, im_num.split('.')[0], name))
                    mask.save(
                        '/media/dsocia22/T7/Trachoma/annotated_data/FollicleDetection/singleFollicleImages/Masks/{}_{}_{}.jpg'.format(
                            mask_ind, im_num.split('.')[0], name))
                    mask_ind += 1
                    print(img_num_save, mask_ind, num_mask, crop_img.size)
            img_num_save += 1

images = glob.glob('/media/dsocia22/T7/Trachoma/annotated_data/FollicleDetection/singleFollicleImages/Images/' + '*.jpg')
...
for t in test:
    ...
    os.replace('/media/dsocia22/T7/Trachoma/annotated_data/FollicleDetection/singleFollicleImages/Images/' + c, '/media/dsocia22/T7/Trachoma/annotated_data/FollicleDetection/singleFollicleImages/Test/Images/' + c)
    os.replace('/media/dsocia22/T7/Trachoma/annotated_data/FollicleDetection/singleFollicleImages/Images/' + l,
              '/media/dsocia22/T7/Trachoma/annotated_data/FollicleDetection/singleFollicleImages/Test/Images/' + l)
    os.replace('/media/dsocia22/T7/Trachoma/annotated_data/FollicleDetection/singleFollicleImages/Masks/' + c,
              '/media/dsocia22/T7/Trachoma/annotated_data/FollicleDetection/singleFollicleImages/Test/Masks/' + c)
    os.replace('/media/dsocia22/T7/Trachoma/annotated_data/FollicleDetection/singleFollicleImages/Masks/' + l,
              '/media/dsocia22/T7/Trachoma/annotated_data/FollicleDetection/singleFollicleImages/Test/Masks/' + l)

    # c_test.append(t + '_chris.jpg')
    # l_test.append(t + '_lindsay.jpg')
